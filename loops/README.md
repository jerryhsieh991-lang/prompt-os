...
**158 reusable agent-loop prompts** across 26 loop families. Each is a copy-pasteable, model-agnostic prompt with an explicit stop condition so an agent iterates to a goal without looping forever.
