...
(`loops/*.md`). It presents the 182 loop prompts across 38 families as a browsable,
...
The generator currently writes 261 HTML pages, plus `data/prompts.json`, `sitemap.xml`,
...
| `families.html` | Index of all 38 loop families. |
| `family/<key>.html` | 38 family pages with prompts and curation notes. |
