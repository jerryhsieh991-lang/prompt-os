...
(`loops/*.md`). It presents the 158 loop prompts across 26 families as a browsable,
...
| `prompt/<id>.html` | 158 prompt detail pages. Tabs: Prompt, Anatomy, Why it works, Source. |
...
build-time browser check confirms **exact parity**: for all 158 corpus prompts the JS engine
